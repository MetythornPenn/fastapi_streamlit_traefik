...
## Reference
- [main docs](https://github.com/tiangolo/blog-posts/blob/master/deploying-fastapi-apps-with-https-powered-by-traefik/README.md)
- [nginx](https://gitlab.com/codeching/docker-multicontainer-application-react-nodejs-postgres-nginx-basic)
- [Deply fastapi app overs https with traefik proxy](https://www.youtube.com/watch?v=7N5O62FjGDc)
- [Point a NameCheap Domain to Digital Ocean Droplet](https://www.youtube.com/watch?v=95BC1b5FVps)